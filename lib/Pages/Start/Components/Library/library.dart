    ...
    return GridView(
      ...
      children: [
        ...
        Playlist(
          ...
          playlistName: "Donkey Kong Country 2 ",
        ...
        Playlist(
          ...
          playlistName: "CCB Orquestra",
          color: Color(0xFFD77943), // #2511ee (Corrigi o último valor inválido: #ff2511e → #2511ee)
        ),
      ],
